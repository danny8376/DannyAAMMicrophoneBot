/*
 * Modified from
 * https://github.com/JMJBower/node-VBAN/blob/09780cc969e9921dcca02864954f08022871a224/vban.js
 */
...
function proccessHeader(headerBuffer) {
    ...
    // *** Patched part ***
    const zeroCharIdx = headers["streamName"].indexOf('\0');
    if (zeroCharIdx !== -1) headers["streamName"] = headers["streamName"].slice(0, zeroCharIdx);
